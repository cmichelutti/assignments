README für das Projekt GameServer (Angepasst an Implementierung von Ploy)

Dieses Projekt dient als Einstieg in die Implementierungsaufgabe. 
...
Funktionen in der Klasse PloyGame und die dazugehörigen Tests (Siehe Aufgabenblatt). Bestehender Code darf nicht geändert werden. 
